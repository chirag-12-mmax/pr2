...
import 'package:onboarding_app/widgets/form_builder_controls/custom_form_date/custom_input_picker_from_field.dart';
...
Future<DateTime?> customShowDatePicker(
    ...
    required final bool isHijriCal}) async {
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    JGlobalDatePicker calendarDatePicker() {
      ...
      return JGlobalDatePicker(
        ...
        pickerType: widget.isHijriDate ? PickerType.JHijri : PickerType.JNormal,
        buttons: const SizedBox(),
        primaryColor: Colors.blue,
        calendarTextColor: Colors.black,
        backgroundColor: Colors.transparent,
        borderRadius: const Radius.circular(10),
        startDate: widget.isHijriDate
            ? JDateModel(dateTime: DateTime.parse("1984-12-24"))
            : JDateModel(dateTime: widget.firstDate),
        selectedDate: widget.isHijriDate
            ? JDateModel(dateTime: _selectedDate.value)
            : JDateModel(dateTime: _selectedDate.value),
        endDate: widget.isHijriDate
            ? JDateModel(dateTime: DateTime.parse("2030-09-20"))
            : JDateModel(dateTime: widget.lastDate),
        pickerMode: DatePickerMode.day,
        pickerTheme: Theme.of(context),
        textDirection: TextDirection.ltr,
        onChange: (val) {
          print("==========My New Date ......${val}");

          _handleDateChanged(val.date);
        },
      );
    }
    ...
    final Widget header = _DatePickerHeader(
      ...
      titleText: _selectedDate.value.toString(),
      titleStyle: headlineStyle,
      orientation: orientation,
      isHijriCal: widget.isHijriDate,
  ...
  Widget build(BuildContext context) {
    ...
    final Widget title = Column(
      children: [
        if (!isHijriCal)
          Text(
            DateFormate.displayDateFormate.format(DateTime.parse(titleText)),
        ...
        if (isHijriCal)
          Text(
            formatDateToHijri(DateTime.parse(titleText)),
            //  _selectedDate.value
            semanticsLabel: titleSemanticsLabel ?? titleText,
